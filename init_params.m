...
I_sc = 10.38;       % 面板短路电流，A
V_oc = 16.25;       % 面板开路电压，需高于母线电压并留有余量，V
G0 = 1366.1;        % 太阳光照常数，地球轨道标准值，W/m^2
I_f = 1e-9;         % 反向饱和电流，表示二极管的漏电流，A
R_s = 0.02;         % 串联电阻，影响电池在负载下的性能，ohm
R_sh = 1000;        % 并联电阻，表示光伏电池的漏泄电流，ohm
V_t = 0.025;        % 热电压，V，通常为$V_t=kT/q$，其中k是玻尔兹曼常数，T是温度，q是电子电荷
n = 1.2;            % 二极管的理想因子
num_s = 25;         % 光伏模块串联电池单元个数。
num_p = 25;         % 光伏模块并联电池单元个数。
