...
adcs.DataScope = 'Auto';
adcs.Alignment = -1;
adcs.PreserveElementDimensions = 0;
adcs.Elements = elems;
clear elems;
...
comm.DataScope = 'Auto';
comm.Alignment = -1;
comm.PreserveElementDimensions = 0;
comm.Elements = elems;
clear elems;
assignin('base','comm', comm);
...
elements = Simulink.Bus;
elements.HeaderFile = '';
elements.Description = '';
elements.DataScope = 'Auto';
elements.Alignment = -1;
elements.PreserveElementDimensions = 0;
elements.Elements = elems;
clear elems;
assignin('base','elements', elements);

% Bus object: euler_angle 
clear elems;
elems(1) = Simulink.BusElement;
elems(1).Name = 'phi';
elems(1).Dimensions = 1;
...
euler_angle = Simulink.Bus;
euler_angle.HeaderFile = '';
euler_angle.Description = '';
euler_angle.DataScope = 'Auto';
euler_angle.Alignment = -1;
euler_angle.PreserveElementDimensions = 0;
euler_angle.Elements = elems;
clear elems;
assignin('base','euler_angle', euler_angle);
...
omega.HeaderFile = '';
omega.Description = '';
omega.DataScope = 'Auto';
omega.Alignment = -1;
omega.PreserveElementDimensions = 0;
omega.Elements = elems;
clear elems;
...
elems(2) = Simulink.BusElement;
elems(2).Name = 'elements';
elems(2).Dimensions = 1;
elems(2).DimensionsMode = 'Fixed';
elems(2).DataType = 'Bus: elements';
elems(2).Complexity = 'real';
elems(2).Min = [];
elems(2).Max = [];
elems(2).DocUnits = '';
...
orbit.HeaderFile = '';
orbit.Description = '';
orbit.DataScope = 'Auto';
orbit.Alignment = -1;
orbit.PreserveElementDimensions = 0;
orbit.Elements = elems;
clear elems;
...
power.HeaderFile = '';
power.Description = '';
power.DataScope = 'Auto';
power.Alignment = -1;
power.PreserveElementDimensions = 0;
power.Elements = elems;
clear elems;
...
propulsion.DataScope = 'Auto';
propulsion.Alignment = -1;
propulsion.PreserveElementDimensions = 0;
propulsion.Elements = elems;
clear elems;
assignin('base','propulsion', propulsion);
...
quan.DataScope = 'Auto';
quan.Alignment = -1;
quan.PreserveElementDimensions = 0;
quan.Elements = elems;
clear elems;
assignin('base','quan', quan);
...
sat.DataScope = 'Auto';
sat.Alignment = -1;
sat.PreserveElementDimensions = 0;
sat.Elements = elems;
clear elems;
...
states.Alignment = -1;
states.PreserveElementDimensions = 0;
